...
///////////////////
			...
			else if (c2 < c1)
			{
				...
				{
					if (c2 < c1*0.25) 
						if (c2 < c1*0.13) fit+=128;
						else fit+=64;
					if (c2 > c1*0.25)
						if (c2 < c1*0.38) fit+=32;
						else fit+=16;
				}
				if (c2 > c1/2)
				{
			...
			else if (c2 > c1)
			{
				...
				{
					if (c2 < c1*2.25)
						if (c2 < c1*2.13) fit+=16;
						else fit+=32;
					if (c2 > c1*2.25)
						if (c2 < c1*2.38) fit+=64;
						else fit+=128;
				}
			}
		...
		for (int y=0; y<IMG_HEIGHT; y++)
		{
			...
			else if (c2 < c1)
			{
				...
				if (c2 > c1/2)
				{
					...
					if (c2 > c1*0.75)
						if (c2 < c1*0.88) mutated.chromosome[x][y]+=rand()%(c1*12/100);
						else mutated.chromosome[x][y]+=rand()%(c1-c2);
				}
			}
			else if (c2 > c1)
			{
				...
				{
					if (c2 < c1*1.25)
						if (c2 < c1*1.12) mutated.chromosome[x][y]-=rand()%(c2-c1);
